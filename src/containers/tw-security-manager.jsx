...
/**
 * Extension sources that are always trusted and loaded automatically without a sandbox.
 */
const TRUSTED_EXTENSION_ORIGINS = [
...
const isTrustedExtension = url => (
    // Always trust our official extension repositories.
    TRUSTED_EXTENSION_ORIGINS.some(origin => url.startsWith(origin)) ||
