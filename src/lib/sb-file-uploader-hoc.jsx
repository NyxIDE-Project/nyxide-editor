    ...
    class SBFileUploaderComponent extends React.Component {
        ...
        createFileObjects () {
            ...
            if (this.props.showOpenFilePicker) {
                ...
                this.inputElement.accept = '.ny,.sb,.sb2,.sb3';
        ...
        handleChange (e) {
            ...
            if (thisFileInput.files) { // Don't attempt to load if no file was selected
                ...
                if (uploadAllowed) {
                    ...
                    if (handle) {
                        if (this.fileToUpload.name.endsWith('.ny') || this.fileToUpload.name.endsWith('.sb3')) {
        ...
        getProjectTitleFromFilename (fileInputFilename) {
            ...
            // (.sb, .sb2, .sb3, and .ny)
            const matches = fileInputFilename.match(/^(.*)\.(sb[23]?|ny)$/);
            if (!matches) return '';
